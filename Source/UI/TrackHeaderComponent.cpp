...
{
    addAndMakeVisibles (*this, { &trackName, &armButton, &muteButton, &soloButton, &inputButton });
...
void TrackHeaderComponent::addAndMakeVisibles(Component & parent, const Array<Component*>& children)
{
	for (auto c : children)
